...
public class HandComponent : BasicBodyComponent {
    ...
    public void update() {
        if (wrist.name == "mixamorig:RightHand") {
            ...
            ikScript.solver.rightHandEffector.rotation = Quaternion.Lerp(ikScript.solver.rightHandEffector.rotation, wristTarget.rotation, 1);
            ...
            ikScript.solver.leftHandEffector.rotation = Quaternion.Lerp(ikScript.solver.leftHandEffector.rotation, wristTarget.rotation, 1);
